<script setup>
    ...
    // Заголовок по роли
    const title = computed(() => (user.value?.role === 'admin' ? 'Админ‑панель' : 'Личный кабинет'))
</script>
            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="flex h-16 justify-between">
                    <div class="flex">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                            <NavLink
                                ...
                                :active="
                                    user?.role === 'admin' ? route().current('admin.dashboard') : route().current('dashboard')
                                "
                            >
                                Dashboard
                            </NavLink>
                    ...
                    <div class="hidden sm:ms-6 sm:flex sm:items-center">
                        <!-- Dropdown только если есть user -->
