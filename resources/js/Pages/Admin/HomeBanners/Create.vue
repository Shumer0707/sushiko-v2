<script setup>
    ...
    const form = useForm({
        ...
        translations: {
            ru: { title: '', description: '', button_text: '', image_desktop: null, image_mobile: null },
            ro: { title: '', description: '', button_text: '', image_desktop: null, image_mobile: null },
            en: { title: '', description: '', button_text: '', image_desktop: null, image_mobile: null },
        },
    })

    const submit = () => {
        form.post(route('admin.home-banners.store'), { forceFormData: true })
    }
</script>

<template>
    <div class="max-w-7xl mx-auto space-y-8 text-admin-text">
        <h1 class="text-xl font-semibold">Добавить баннер</h1>
            ...
            <div class="space-y-6">
                ...
                <div v-for="lang in ['ru', 'ro', 'en']" :key="lang" class="border rounded-lg p-4 space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label class="font-semibold block mb-1">Desktop картинка</label>
                        ...
                        <div>
                            <label class="font-semibold block mb-1">Mobile картинка</label>
