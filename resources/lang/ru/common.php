...
return [
    ...
    'home_seo_2_des' => 'Доставка от 60 минут. Бесплатно по Кишиневу от ' . config('shop.free_delivery_amount') . ' лей .',
    ...
    'contacts_email_address' => config('shop.email_shop'),
    'contacts_latitude' => config('shop.latitude_shop'),
    'contacts_longitude' => config('shop.longitude_shop'),
    'contacts_map_url' => config('shop.map_url'),
    'contacts_instagram_url' => config('shop.instagram_url'),
    'contacts_facebook_url' => config('shop.facebook_url'),
    'contacts_telegram_url' => config('shop.telegram_url'),
    ...
    'cart_summary_until_free_text' => 'для бесплатной доставки (при заказе от ' . config('shop.free_delivery_amount') . ' леев)',
    'cart_summary_until_standard' => 'Добавьте ещё',
    'cart_summary_standard_delivery_cost' => 'доставка будет стоить',
    'cart_summary_within_city' => 'в черте города',
    ...
    'checkout_delivery_city_note' => 'Указанные тарифы действуют в черте города.',
