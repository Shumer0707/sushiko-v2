...
return [
    ...
    'about' => 'О нас',
    'contact' => 'Контакты',
    'phone_time' => 'с 10:00 до 22:00 Доставка занимает в среднем 40 минут.',
    ...
    'home_ban_description_2' => 'При заказе от 500 лей доставляем бесплатно по всему Кишиневу',
    ...
    'home_seo_2_des' => 'Доставка за 60 минут. Бесплатно от 500 лей.',
    'home_seo_3_title' => 'Японские мастера',
    'home_seo_3_des' => 'Наши повара обучались в Японии. Аутентичные рецепты.',
    ...
    'contacts_address_text' => 'ул. Штефан чел Маре 10, Кишинёв, Молдова',
    ...
    'contacts_hours_weekdays' => 'Пн-Пт:',
    'contacts_hours_weekdays_time' => '10:00 - 23:00',
    'contacts_hours_weekend' => 'Сб-Вс:',
    ...
    'cart_summary_until_free_text' => 'для бесплатной доставки',
    ...
    'footer_adress' => 'Кишинёв, ул. Примерная 123',
